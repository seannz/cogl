...
void transform(float *img, size_t stride, float* buf)
{
    ...
    // stage 3 even even
    __m256 o0 = (u0 + u1) * _mm256_set1_ps(M_SQRT1_2 / 2);
    __m256 o4 = (u0 - u1) * _mm256_set1_ps(M_SQRT1_2 / 2);
    ...
    // stage 3 even even
    o0 = (u0 + u1) * _mm256_set1_ps(M_SQRT1_2 / 2);
    o4 = (u0 - u1) * _mm256_set1_ps(M_SQRT1_2 / 2);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    int istri = 1;
    int jstri = dimi[0];
    int kstri = dimi[0]*dimi[1];

    int istro = dimo[0]/deci;
    int jstro = dimo[0]*dimo[1]/deci;
    int kstro = dimo[0]*dimo[1]*dimo[2];
