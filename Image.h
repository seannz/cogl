...
class Image : public Window {
  public:
    ...
    Image(int frames_, int width_, int height_, int channels_) {
	frames = frames_;
	width = width_;
	height = height_;
	channels = channels_;
	...
	memset(data, 0, memory * sizeof(float));
    ...
    Image(int frames_, int width_, int height_, int channels_, float *data_) {
	frames = frames_;
	width = width_;
	height = height_;
	channels = channels_;
